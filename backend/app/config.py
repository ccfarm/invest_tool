...
# 红利低波：连续 5 个完整财年现金分红，5 年平均股息率不低于 3%。
DIVIDEND_INTERVAL = int(os.getenv("DIVIDEND_INTERVAL", "21600"))
DIVIDEND_YEARS = int(os.getenv("DIVIDEND_YEARS", "5"))
DIVIDEND_MIN_AVG_YIELD = float(os.getenv("DIVIDEND_MIN_AVG_YIELD", "3"))
DIVIDEND_CANDIDATE_POOL = int(os.getenv("DIVIDEND_CANDIDATE_POOL", "150"))
DIVIDEND_TOP_N = int(os.getenv("DIVIDEND_TOP_N", "50"))
DIVIDEND_KLINE_DAYS = int(os.getenv("DIVIDEND_KLINE_DAYS", "1300"))
DIVIDEND_CONCURRENCY = int(os.getenv("DIVIDEND_CONCURRENCY", "8"))
